...
$router->get('/admin/security/users/edit', [SecurityController::class, 'adminEditUsers'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, SuperAdminMiddleware::class]);
...
$router->get('/master-data/suppliers', [ControlController::class, 'manageSuppliers'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, SuperAdminMiddleware::class]);
$router->get('/master-data/account-supplier-links', [ControlController::class, 'accountSupplierLinks'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, SuperAdminMiddleware::class]);
$router->get('/linked-party-settlements', [ControlController::class, 'linkedPartySettlements'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, FinancialAdminMiddleware::class]);
...
$router->get('/reports/account-ledger-print', [ReportsController::class, 'accountLedgerPrint'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class]);
$router->get('/reports/print', [ReportsController::class, 'printReport'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class]);
...
$router->get('/suppliers/settlements/global/history', [ReportsController::class, 'globalSupplierPaymentHistory'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class]);
...
$router->post('/suppliers/settlements/global/void', [ReportsController::class, 'voidGlobalSupplierSettlement'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, FinancialAdminMiddleware::class]);
$router->post('/suppliers/settlements/global/supplier-correct', [ReportsController::class, 'correctGlobalSupplierPaymentSupplier'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, FinancialAdminMiddleware::class]);
$router->post('/suppliers/payments/correct', [ReportsController::class, 'correctSupplierPayment'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, FinancialAdminMiddleware::class]);
...
$router->get('/customers/advances/available', [ReportsController::class, 'availableCustomerAdvances'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class]);
$router->get('/customers/advances/receipt', [ReportsController::class, 'customerAdvanceReceipt'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class]);
$router->post('/customers/advances', [ReportsController::class, 'saveCustomerAdvance'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class]);
$router->post('/customers/advances/refund', [ReportsController::class, 'refundCustomerAdvance'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class]);
$router->post('/customers/advances/correct', [ReportsController::class, 'correctCustomerAdvance'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class]);
$router->post('/customers/advances/refund/correct', [ReportsController::class, 'correctCustomerAdvanceRefund'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class]);
...
$router->post('/master-data/suppliers/update', [ControlController::class, 'updateSupplierMaster'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, SuperAdminMiddleware::class]);
...
$router->post('/master-data/account-supplier-links/save', [ControlController::class, 'saveAccountSupplierLink'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, SuperAdminMiddleware::class]);
$router->post('/master-data/account-supplier-links/unlink', [ControlController::class, 'unlinkAccountSupplierLink'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, SuperAdminMiddleware::class]);
$router->post('/linked-party-settlements/save', [ControlController::class, 'saveLinkedPartySettlement'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, FinancialAdminMiddleware::class]);
$router->post('/linked-party-settlements/void', [ControlController::class, 'voidLinkedPartySettlement'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, FinancialAdminMiddleware::class]);
...
$router->post('/treasury/direct/save', [TreasuryController::class, 'saveDirectEntry'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, SuperAdminMiddleware::class]);
...
$router->post('/workspace/client-log', [WorkspaceController::class, 'logClientRuntime'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class]);
...
$router->post('/workspace/business-sources/register', [WorkspaceController::class, 'registerBusinessSource'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class]);
...
$router->post('/workspace/services/cancellation-financials/reverse', [WorkspaceController::class, 'reverseCancellationSettlement'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, FinancialAdminMiddleware::class]);
$router->post('/workspace/services/penalty-refund/correct', [WorkspaceController::class, 'correctPenaltyRefundWorkflow'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, FinancialAdminMiddleware::class]);
$router->post('/workspace/services/cancel/reopen', [WorkspaceController::class, 'reopenCancelledService'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, FinancialAdminMiddleware::class]);
$router->post('/workspace/services/financial-correction', [WorkspaceController::class, 'correctServiceFinancials'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, FinancialAdminMiddleware::class]);
...
$router->post('/workspace/services/refund/reverse', [WorkspaceController::class, 'reverseRefundService'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, FinancialAdminMiddleware::class]);
...
$router->post('/workspace/suppliers/payments/supplier-correct', [WorkspaceController::class, 'correctSupplierPaymentSupplier'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, FinancialAdminMiddleware::class]);
...
$router->get('/suppliers/advances/history', [WorkspaceController::class, 'globalSupplierAdvanceHistory'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, FinancialAdminMiddleware::class]);
$router->post('/suppliers/advances/correct', [WorkspaceController::class, 'correctGlobalSupplierAdvance'], [AuthMiddleware::class, PasswordChangeRequiredMiddleware::class, TwoFactorSetupRequiredMiddleware::class, TwoFactorVerifiedMiddleware::class, FinancialAdminMiddleware::class]);
